...
public class FileUtils {
    ...
    public static final String ROOT_DIR = "Dicctionary";
    public static final String DOWNLOAD_DIR = "download";
    public static final String CACHE_DIR = "cache";
    public static final String DEBUG_INFO_DIR = "debug";
...
//            LogUtils.info(FileUtils.class, e.getMessage());
            return false;
        } finally {
...
//            LogUtils.info(FileUtils.class, e.getMessage());
     ...
     * 判断json数据是否存在
     */
    public static boolean isJsonExist(String url) {
        File file = new File(getCacheDir() + getCacheKey(url));
     ...
     * 判断json数据是否存在
     */
    public static boolean isDataBaseExist(String url) {
     ...
     * 缓存json数据
     */
    public static void cacheJsonToDisk(final String url, final String json) {
        writeFile(json, getCacheDir() + getCacheKey(url), false);
    }

    /**
     * 缓存对象数据
     */
    public static void cacheObjToDisk(final String url, final Object obj) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                String json = JsonUtils.toJson(obj);
                Log.i("jim", "返回json数据 = "+json);
                writeFile(json, getCacheDir() + getCacheKey(url), false);
            }
        }).start();
    }
     ...
     * 从Disk中获取缓存的json数据
     */
    public static String getJsonFromDisk(String url) {
        return readFile(getCacheDir() + getCacheKey(url));
    }

    /**
     * 删除json文件
     */
    public static void deleteJsonFromDisk(String url) {
...
//            LogUtils.info(FileUtils.class, e.getMessage());
    ...
    public static String getDBPath(String dbName) {
		String folderPath = getExternalStoragePath() +"/" + "db";
		checkExist(folderPath);
